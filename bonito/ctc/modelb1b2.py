...
class ModelB1B2(Module):
    """
    Model template for QuartzNet style architectures
    https://arxiv.org/pdf/1910.10261.pdf
    """
    def __init__(self, config):
        super(ModelB1B2, self).__init__()
...
###########################################################################################################################
        ...
        b10_b=Block_repeat( 172, 280, activation,
        ...
        b2_b=Block_repeat( 280, 214, activation,
                repeat=2, kernel_size=115,
                stride=1, dilation=1,
                dropout=0.05, residual=False,
                separable=True,
    ...
    ###########################################################################################################################
        ...
        c3_b=Block( 214,48, activation,
                    repeat=1, kernel_size=15,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=False,
                    quant=8,quant_act=4)
