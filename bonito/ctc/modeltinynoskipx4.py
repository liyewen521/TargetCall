...
class ModelTinyNoSkipX4(Module):
    """
    Model template for QuartzNet style architectures
    https://arxiv.org/pdf/1910.10261.pdf
    """
    def __init__(self, config):
        super(ModelTinyNoSkipX4, self).__init__()
...
class Encoder(Module):
    ...
    def __init__(self, config):
        ...
        c1_b=Block( 1, 6, activation,
                        repeat=1, kernel_size=9,
                        stride=3, dilation=1,
                        dropout=0.05, residual=False,
                        separable=False)

        b10_b=Block_repeat( 6, 10, activation,
                repeat=2, kernel_size=75,
                stride=1, dilation=1,
                dropout=0.05, residual=True,
                separable=True)
        b11_b=Block_repeat( 10, 10, activation,
                    repeat=1, kernel_size=31,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b14_b=Block_repeat( 10, 10, activation,
                    repeat=2, kernel_size=31,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b23_b=Block_repeat( 10, 6, activation,
                    repeat=1, kernel_size=123,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b31_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=55,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b34_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=5,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b35_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=3,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b40_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b41_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=115,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b43_b=Block_repeat( 6,6, activation,
                    repeat=2, kernel_size=55,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b44_b=Block_repeat( 6,4, activation,
                    repeat=2, kernel_size=25,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b51_b=Block_repeat( 4,4 ,activation,
                    repeat=2, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b52_b=Block_repeat( 4,4 ,activation,
                    repeat=1, kernel_size=25,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b54_b=Block_repeat( 4,4 ,activation,
                    repeat=2, kernel_size=7,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b55_b=Block_repeat( 4,4 ,activation,
                    repeat=1, kernel_size=123,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        c2_b=Block( 4,4, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=True,
                    quant=8,quant_act=4)
        c3_b=Block( 4,6, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=False)
