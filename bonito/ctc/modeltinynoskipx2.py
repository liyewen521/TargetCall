...
class ModelTinyNoSkipX2(Module):
    """
    Model template for QuartzNet style architectures
    https://arxiv.org/pdf/1910.10261.pdf
    """
    def __init__(self, config):
        super(ModelTinyNoSkipX2, self).__init__()
...
class Encoder(Module):
    ...
    def __init__(self, config):
        ...
        b10_b=Block_repeat( 24, 40, activation,
                repeat=2, kernel_size=75,
                stride=1, dilation=1,
                dropout=0.05, residual=True,
                separable=True,
                quant=16,quant_act=16)
        b11_b=Block_repeat( 40, 40, activation,
        ...
        b14_b=Block_repeat( 40, 40, activation,
                    repeat=2, kernel_size=31,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b23_b=Block_repeat( 40, 24, activation,
                    repeat=1, kernel_size=123,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b31_b=Block_repeat( 24,24, activation,
                    repeat=2, kernel_size=55,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b34_b=Block_repeat( 24,24, activation,
                    repeat=2, kernel_size=5,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b35_b=Block_repeat( 24,24, activation,
                    repeat=2, kernel_size=3,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b40_b=Block_repeat( 24,24, activation,
                    repeat=2, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b41_b=Block_repeat( 24,24, activation,
        ...
        b43_b=Block_repeat( 24,24, activation,
                    repeat=2, kernel_size=55,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b44_b=Block_repeat( 24,16, activation,
                    repeat=2, kernel_size=25,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b51_b=Block_repeat( 16,16 ,activation,
                    repeat=2, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b52_b=Block_repeat( 16,16 ,activation,
        ...
        b54_b=Block_repeat( 16,16 ,activation,
                    repeat=2, kernel_size=7,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b55_b=Block_repeat( 16,16 ,activation,
                    repeat=1, kernel_size=123,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        c2_b=Block( 16,16, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=True)
        c3_b=Block( 16,24, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=False)
