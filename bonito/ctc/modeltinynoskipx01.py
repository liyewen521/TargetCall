...
class ModelTinyNoSkipX01(Module):
    """
    Model template for QuartzNet style architectures
    https://arxiv.org/pdf/1910.10261.pdf
    """
    def __init__(self, config):
        super(ModelTinyNoSkipX01, self).__init__()
...
###########################################################################################################################
        ...
        b10_b=Block_repeat( 48, 80, activation,
                repeat=2, kernel_size=75,
                stride=1, dilation=1,
                dropout=0.05, residual=True,
                separable=True)
        b11_b=Block_repeat( 80, 80, activation,
        ...
        b14_b=Block_repeat( 80, 80, activation,
        ...
        b23_b=Block_repeat( 80, 48, activation,
        ...
        b31_b=Block_repeat( 48,48, activation,
        ...
        b34_b=Block_repeat( 48,48, activation,
                    repeat=2, kernel_size=5,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b35_b=Block_repeat( 48,48, activation,
        ...
        b44_b=Block_repeat( 48,32, activation,
        ...
        b51_b=Block_repeat( 32,32 ,activation,
                    repeat=2, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)

        b52_b=Block_repeat( 32,32 ,activation,
        ...
        b54_b=Block_repeat( 32,32 ,activation,
                    repeat=2, kernel_size=7,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
        b55_b=Block_repeat( 32,32 ,activation,
                    repeat=1, kernel_size=123,
                    stride=1, dilation=1,
                    dropout=0.05, residual=True,
                    separable=True)
    ...
    ###########################################################################################################################
        c2_b=Block( 32,32, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=True)
        c3_b=Block( 32,48, activation,
                    repeat=1, kernel_size=9,
                    stride=1, dilation=1,
                    dropout=0.05, residual=False,
                    separable=False)
